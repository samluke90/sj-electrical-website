...
user_setup:
  - service: formspree
    why: "Form backend to receive submissions and deliver to samluke90@gmail.com"
    status: "CONFIGURED"
    form_id: "xreedakb"
    endpoint: "https://formspree.io/f/xreedakb"
    notification_email: "samluke90@gmail.com"
...
<task type="auto">
  ...
  <action>
    ...
    1. Replace the form action attribute:
       - Change `action="https://api.web3forms.com/submit"` to `action="https://formspree.io/f/xreedakb"`
...
<success_criteria>
1. Form action points to Formspree endpoint (https://formspree.io/f/xreedakb)
